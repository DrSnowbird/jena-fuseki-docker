...
curl -L -X POST "http://0.0.0.0:13030/rdf002/" -H "Content-Type: application/trig" -H "Accept: application/sparql-results+json" --data-binary "@SusanJohns-graph.ttl.trig"
